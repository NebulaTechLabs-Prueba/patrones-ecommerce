/**
 * Contenido "Nosotros" (misión, valores y portfolio institucional), fusionado
 * dentro de la página Esencia. Amplía la percepción de la marca (§2): PATRONES es
 * multi-rubro. El portfolio muestra CAPACIDADES de dotación, no clientes ficticios.
 */
...
const VALUES = [
  ...
  },
  {
    ...
    d: 'Diseñamos y producimos nuestra confección propia, y sumamos marcas seleccionadas para ampliar opciones sin resignar calidad.',
  },
];
      ...
      <section className={styles.hero}>
        <Reveal className={styles.heroInner}>
          ...
          <p className={styles.lead}>
            Nacimos vistiendo al personal de salud y hoy equipamos al profesional entero: uniformes de alto
            rendimiento para cada rubro —salud, gastronomía, corporativo y más—, sumados a calzado, perfumería y
            complementos. Una sola casa que combina su línea propia con marcas seleccionadas, de pies a cabeza.
          </p>
        </Reveal>
      </section>
