...
export const products: Product[] = [
  ...
  // --- Calzado -------------------------------------------------------------
  {
    ...
    description:
      'El zueco Crocs original en espuma Croslite: ligero, lavable y ventilado. Comodidad reconocida para turnos de pie, dentro y fuera del trabajo.',
    type: 'simple',
    model_id: 'm-crocs-classic',
    brand_id: 'b-crocs',
    origin: 'importado',
    // N:N: comodidad clínica y también uso diario.
    vertical_ids: ['v-calzado', 'v-salud'],
    category_ids: ['cat-calzado'],
    price: 4500,
    featured: true,
    low_stock_threshold: null,
    customization: customizationOff,
    images: [
      stock('1595950653106-6c9ebd614d3a', 'Crocs Classic Clog, vista lateral', 0),
    ],
    set_pieces: [],
    created_at: '2026-06-28T10:00:00-04:00',
  },
  {
    id: 'p-nike-revolution',
    slug: 'nike-revolution-running',
    name: 'Nike Revolution Running',
    description:
      'Zapatilla de running con amortiguación ligera y malla transpirable. Pisada suave para entrenar o para acompañar tu día a tu ritmo.',
    type: 'simple',
    model_id: 'm-nike-run',
    brand_id: 'b-nike',
    origin: 'importado',
    ...
    customization: customizationOff,
    images: [
      stock('1542291026-7eec264c27ff', 'Nike Revolution Running, vista lateral', 0),
    ],
    set_pieces: [],
  ...
  // --- Perfumería ----------------------------------------------------------
  {
    ...
    description:
      'Fragancia envolvente de notas amaderadas y ámbar, de estela prolongada. Presencia sobria para la jornada y para después.',
    type: 'simple',
    model_id: 'm-essenza',
    brand_id: 'b-essenza',
    origin: 'importado',
    ...
    customization: customizationOff,
    images: [
      stock('1615634260167-c8cdede054de', 'Eau de Parfum Noir, frasco', 0),
    ],
    set_pieces: [],
  ...
  {
    id: 'p-perfume-blanc',
    slug: 'eau-de-toilette-blanc',
    name: 'Eau de Toilette Blanc',
    description:
      'Fragancia fresca de notas cítricas y florales, ligera para el uso diario. La firma discreta que acompaña sin imponerse.',
    type: 'simple',
    model_id: 'm-essenza',
    brand_id: 'b-essenza',
    origin: 'importado',
    ...
    customization: customizationOff,
    images: [
      stock('1541643600914-78b084683601', 'Eau de Toilette Blanc, frasco', 0),
    ],
    set_pieces: [],
    created_at: '2026-06-15T10:00:00-04:00',
  },
  ...
  {
    id: 'p-cartera-tote',
    slug: 'cartera-tote-metropolitana',
    name: 'Cartera Tote Metropolitana',
    description:
      'Bolso tote amplio en cuero sintético de tacto suave, con asa al hombro y bolsillo interior. Del trabajo a la calle sin cambiar de bolso.',
    type: 'simple',
    model_id: 'm-atelier',
    brand_id: 'b-linea-patrones',
    origin: 'importado',
    vertical_ids: ['v-complementos'],
    category_ids: ['cat-carteras'],
    price: 4200,
    featured: true,
    low_stock_threshold: null,
    customization: customizationOff,
    images: [
      stock('1584917865442-de89df76afd3', 'Cartera Tote Metropolitana, vista frontal', 0),
    ],
    set_pieces: [],
  ...
  {
    id: 'p-set-bisuteria',
    slug: 'set-bisuteria-esencial',
    name: 'Set de Bisutería Esencial',
    description:
      'Conjunto de collar y aretes en acero inoxidable dorado, hipoalergénico y resistente al uso diario. El acento que completa el look.',
    type: 'simple',
    model_id: 'm-atelier',
    brand_id: 'b-linea-patrones',
    origin: 'importado',
    vertical_ids: ['v-complementos'],
    category_ids: ['cat-bisuteria'],
    price: 1800,
    featured: false,
    low_stock_threshold: null,
    customization: customizationOff,
    images: [
      stock('1571945153237-4929e783af4a', 'Set de bisutería en acero dorado', 0),
    ],
    set_pieces: [],
    created_at: '2026-06-10T10:00:00-04:00',
  },
  ...
  {
    id: 'p-legging-active',
    slug: 'legging-active-high',
    name: 'Legging Active High',
    description:
      'Legging de tiro alto en tejido técnico de compresión suave, opaco y elástico en cuatro direcciones. Libertad de movimiento para entrenar.',
    type: 'simple',
    model_id: 'm-active',
    brand_id: 'b-linea-patrones',
    origin: 'nacional',
    vertical_ids: ['v-deportivo'],
    category_ids: ['cat-deportiva'],
    price: 2900,
    featured: true,
    low_stock_threshold: null,
    customization: customizationOff,
    images: [
      stock('1594633312681-425c7b97ccd1', 'Legging Active High, vista frontal', 0),
    ],
    set_pieces: [],
    created_at: '2026-07-02T10:00:00-04:00',
  },
  {
    id: 'p-nike-tee',
    ...
    description:
      'Camiseta deportiva en tejido Dri-FIT que aparta el sudor de la piel para un secado rápido. Ligera y transpirable para cualquier rutina.',
    type: 'simple',
    model_id: 'm-active',
    brand_id: 'b-nike',
    origin: 'importado',
    ...
    customization: customizationOff,
    images: [
      stock('1608231387042-66d1773070a5', 'Nike Dri-FIT Tee, vista frontal', 0),
    ],
    set_pieces: [],
    created_at: '2026-07-02T10:00:00-04:00',
  },
