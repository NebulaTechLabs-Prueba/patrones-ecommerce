...
export const brands: Brand[] = [
  {
    ...
    description:
      'La línea propia de PATRONES: diseñada y producida por la casa, con la calidad y el criterio que definen cada prenda.',
    is_own_line: true,
  ...
  // --- Marcas del inventario real (extraídas de "MARCA X" en cada referencia) ---
  { id: 'b-cherokee', slug: 'cherokee', name: 'Cherokee', is_own_line: false, logo_image: null },
  { id: 'b-skechers', slug: 'skechers', name: 'Skechers', is_own_line: false, logo_image: null },
  { id: 'b-skywox', slug: 'skywox', name: 'Skywox', is_own_line: false, logo_image: null },
  { id: 'b-importado', slug: 'importado', name: 'Importado', is_own_line: false, logo_image: null },
  { id: 'b-industry-line', slug: 'industry-line', name: 'Industry Line', is_own_line: false, logo_image: null },
  { id: 'b-general', slug: 'general', name: 'General', is_own_line: false, logo_image: null },
  { id: 'b-infinity', slug: 'infinity', name: 'Infinity', is_own_line: false, logo_image: null },
  { id: 'b-cu', slug: 'cu', name: 'CU', is_own_line: false, logo_image: null },
  { id: 'b-medicapparel', slug: 'medicapparel', name: 'Medicapparel', is_own_line: false, logo_image: null },
  { id: 'b-dickies', slug: 'dickies', name: 'Dickies', is_own_line: false, logo_image: null },
  { id: 'b-michael-kors', slug: 'michael-kors', name: 'Michael Kors', is_own_line: false, logo_image: null },
  { id: 'b-barco', slug: 'barco', name: 'Barco', is_own_line: false, logo_image: null },
  { id: 'b-parchita', slug: 'parchita', name: 'Parchita', is_own_line: false, logo_image: null },
  { id: 'b-healing-hands', slug: 'healing-hands', name: 'Healing Hands', is_own_line: false, logo_image: null },
  { id: 'b-juanita-jo', slug: 'juanita-jo', name: 'Juanita Jo', is_own_line: false, logo_image: null },
  { id: 'b-juanita', slug: 'juanita', name: 'Juanita', is_own_line: false, logo_image: null },
  { id: 'b-project', slug: 'project', name: 'Project', is_own_line: false, logo_image: null },
  { id: 'b-babalu', slug: 'babalu', name: 'Babalu', is_own_line: false, logo_image: null },
  { id: 'b-timberbrother', slug: 'timberbrother', name: 'Timberbrother', is_own_line: false, logo_image: null },
  { id: 'b-bonlife', slug: 'bonlife', name: 'Bonlife', is_own_line: false, logo_image: null },
  { id: 'b-sandjest', slug: 'sandjest', name: 'Sandjest', is_own_line: false, logo_image: null },
  { id: 'b-cavn', slug: 'cavn', name: 'Cavn', is_own_line: false, logo_image: null },
  { id: 'b-hypothesis', slug: 'hypothesis', name: 'Hypothesis', is_own_line: false, logo_image: null },
  { id: 'b-chef', slug: 'chef', name: 'Chef', is_own_line: false, logo_image: null },
  { id: 'b-sooverki', slug: 'sooverki', name: 'Sooverki', is_own_line: false, logo_image: null },
  { id: 'b-butter-soft', slug: 'butter-soft', name: 'Butter-soft', is_own_line: false, logo_image: null },
  { id: 'b-inizio', slug: 'inizio', name: 'Inizio', is_own_line: false, logo_image: null },
  { id: 'b-zhmo', slug: 'zhmo', name: 'Zhmo', is_own_line: false, logo_image: null },
  { id: 'b-neer', slug: 'neer', name: 'Neer', is_own_line: false, logo_image: null },
  { id: 'b-duuv', slug: 'duuv', name: 'Duuv', is_own_line: false, logo_image: null },
  { id: 'b-victoria', slug: 'victoria', name: 'Victoria', is_own_line: false, logo_image: null },
  { id: 'b-zhehao', slug: 'zhehao', name: 'Zhehao', is_own_line: false, logo_image: null },
];
